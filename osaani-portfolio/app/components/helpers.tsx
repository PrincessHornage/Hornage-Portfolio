...
import { faLaptopCode, faPhoneSquare } from '@fortawesome/free-solid-svg-icons';
import { ResizeBtns } from './utils/utils.js'; 
import { ShowSelectedProjs } from './utils/utils.js';
...
const CHARS = "!@#$%^&*():{};|,.<>/?";
const basePath = "/pth3035/portfolio-site"; 
        ...
        <section className="hero is-medium ">
          <div className="hero-body is-size-3 subtitle">
            <p className="title is-size-1">Designing Play, Developing Joy!</p>
              ...
              <br/>
              Im fluent in <strong>HTML,</strong> <strong>C#,</strong> and <strong>JavaScript,</strong> with plenty more skills in my inventory. 
      ...
      <div className="column">
        <section className="section is-medium">
          <figure className="image is-rounded hover-image-container">
            <img 
              src= {`${basePath}/longboarding.png`} 
              alt="Person Longboarding" 
              className='default-img'
            />

            <img
              src={`${basePath}/watching-anime.png`}
        ...
        <div className="columns">
          ...
          <div className="column is-flex is-justify-content-center is-align-items-center">
            <figure className="image">
              <img src={`${basePath}/web-developer.png`} alt="Full Stack Developer" id='developerImg'/>
            </figure>
          </div>
        </div>
      </section>
            ...
            <div className=" is-flex is-justify-content-center is-align-items-center mb-6 ">
              <div id="logo-wheel">
                <div id="logo">
                  <figure className="image is-64x64">
                    <img src= {`${basePath}/c-sharp.png`} alt="C#"/>
                  </figure>
                </div>
                <div id="logo">
                  <figure className="image is-64x64">
                    <img src={`${basePath}/c-plus.png`} alt="C#" />
                  </figure>
                </div>
              ...
              <div id="center-img">
                <figure className="image is-128x128">
                  <img src={`${basePath}/female-programmer.png`} alt="Female Programmer on Laptop" />
                </figure>
              </div>
            </div>
            </div>
            <div className="column is-flex is-justify-content-center is-align-content-center is-align-items-center is-align-self-center">
              ...
              <div className="is-flex is-justify-content-center is-align-items-center">
                <div id="tool-logo-wheel">
                  <div id="tools-logo">
                    <figure className="image is-64x64">
                      <img src={`${basePath}/photoshop.png`} alt="Adobe Photoshop" />
                    </figure>
                  </div>
                  <div id="tools-logo">
                    <figure className="image is-64x64">
                      <img src={`${basePath}/after-effects.png`} alt="Adobe After Effects" />
                    </figure>
                  </div>
                  ...
                  <div id="tools-logo">
                    <figure className="image is-64x64">
                      <img src={`${basePath}/visual-studio.png"`} alt="Visual Studios" />
                    </figure>
                  </div>
                  <div id='tools-logo'>
                    <figure className='image is-128x128'>
                      <img src={`${basePath}/arcGIS-logo.png`} alt="ArcGIS" />
                    </figure>
                  </div>
                  <div id='tools-logo'>
                    <figure className="image">
                      <img src={`${basePath}/axure-logo.png`} alt="Axure" />
                    </figure>
                  </div>
                  <div id='tools-logo'>
                    <figure className="image">
                      <img src={`${basePath}/maya-logo.png`} alt="Maya" />
                    </figure>
                  </div>
                  <div id="center-img-2">
                    <figure className="image is-128x128">
                      <img src={`${basePath}/tools-and-tech.png`} alt="Eletronics" />
                    </figure>
                  </div>
                </div>
              </div>
...
export function WebProjectPreview(
  {imageURL, altText, demoURL, gitHubURL}: {imageURL:string, altText: string, demoURL: string, gitHubURL: string}
){ 
  return(
    <div id='web-project'>
      <figure className='image'>
        <img src={`${basePath}/laptop.png`} alt="Laptop" id="laptop-img" />
  ...
  return(
    <div id='mobile-project'>
      <figure className="image" id='iPhone-container'>
        <img src={`${basePath}/iPhone.png`} alt="iPhone" id="iPhone-img" />
